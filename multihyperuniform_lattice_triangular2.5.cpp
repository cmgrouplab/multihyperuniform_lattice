...
//modified: 02/21/2025
//modify the lattice vectors to be consistent with James' system
...
#define MAXX 24 //the linear dimension of the lattice, applying to all lattice, w.r.t. the unit cell
#define MAXY 24 //the linear dimension along the y direction, must be an even number
...
double alpha = 0.95; //the cooling schedule parameter
int TN = 30; //the cooling stages
double T = 0.005; //the current temperature
