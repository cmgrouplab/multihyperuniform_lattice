...
#define MAXX 8 //the linear dimension of the lattice, applying to all lattice, w.r.t. the unit cell
#define N_tot MAXX*MAXX //the total number of particles, assuming all sites will be occupied
...
int config[MAXX][MAXX]; //this gives the index of particle occupying each lattice site, -1 for unoccupied sites or vacancies
...
double T = 0.05; //the current temperature
