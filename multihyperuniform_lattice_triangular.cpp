...
#define MAXX 16 //the linear dimension of the lattice, applying to all lattice, w.r.t. the unit cell
#define MAXY 32 //the linear dimension along the y direction, must be an even number

#define N_tot MAXX*MAXY //the total number of particles, assuming all sites will be occupied

#define n_s 4 //number of species
...
void read_parameters()
{
  ...
  double box_length = get_max(box_length_x, box_length_y);
